...
export default class Learn3Screen extends React.Component{
  render(){
    return(
      <View>
      ...
      <View>
        ...
        <Text style={{textAlign:'center',fontWeight:'bold',fontSize:25,marginTop:20}}>WH Word Signs </Text>

        <View>
          <Image source={require('../assets/wh_crop.jpg')} style={{marginLeft:10,marginTop:20,width:300,height:390,}}/>
        </View>

        <Hyperlink linkDefault={ true }>
    <Text style={ { fontSize: 20,marginTop:20,fontWeight:'bold',color:'black',textAlign:'center' } }>
      Practice Better - <iframe width="250" height="315" src="https://www.youtube.com/embed/iJ7PZUCTirU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </Text>
  </Hyperlink>
        ...
        <View>
          <TouchableOpacity 
             onPress={()=>{this.props.navigation.navigate('Learn4Screen')} } 
