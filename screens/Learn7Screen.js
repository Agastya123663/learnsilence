...
export default class Learn7Screen extends React.Component{
  render(){
    ...
    <Text style={ { fontSize: 20,marginTop:20,fontWeight:'bold',color:'black',textAlign:'center' } }>
      Practice Better - <iframe width="250" height="315" src="https://www.youtube.com/embed/bhD6QC1IEOs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </Text>
  </Hyperlink>
